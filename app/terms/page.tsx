        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing and using CodeLens, you accept and agree to be bound by
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              CodeLens is an AI-powered code review service that analyzes your code
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              owned by CodeLens and are protected by international copyright,
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              CodeLens provides code review suggestions and analysis, but we do not
