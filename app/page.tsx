    ...
    >
      <motion.div variants={fadeIn} className="text-center mb-16">
        <p className="font-mono text-muted-foreground mb-4">
          Also Available in{" "}
          <span className="underline decoration-primary underline-offset-4 text-foreground cursor-pointer">
            CLI
          </span>{" "}
          &{" "}
          <span className="underline decoration-primary underline-offset-4 text-foreground cursor-pointer">
      ...
      <div className="grid md:grid-cols-3 gap-px bg-white/10 max-w-5xl mx-auto border border-white/10 rounded-lg overflow-hidden">
        <motion.div
          variants={fadeIn}
          className="bg-background p-12 flex flex-col items-center justify-center text-center gap-4 hover:bg-white/[0.02] transition-colors"
        >
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <div className="flex items-center gap-1.5 font-bold text-xl text-orange-500">
              <Gitlab className="size-6" /> GitLab
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          variants={fadeIn}
          className="bg-background p-12 flex flex-col items-center justify-center text-center relative overflow-hidden group"
        >
          ...
          <span className="text-5xl md:text-6xl font-bold tabular-nums group-hover:scale-110 transition-transform duration-500">
            2M
          </span>
        ...
        <motion.div
          variants={fadeIn}
          className="bg-background p-12 flex flex-col items-center justify-center text-center hover:bg-white/[0.02] transition-colors"
        >
  ...
  <section className="py-24 container mx-auto px-4">
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <motion.p
          variants={fadeIn}
          className="text-xl text-muted-foreground font-mono max-w-2xl text-balance"
        >
        ...
        <motion.div variants={fadeIn}>
          <Link
            href="#"
            className="flex items-center gap-2 text-primary hover:text-primary/80 transition-colors font-mono"
          >
    ...
    >
      ...
      <FeatureCard>
        <div className="flex-1 flex items-center justify-center py-10 opacity-80 group-hover:opacity-100 transition-opacity">
          <motion.div
            variants={cardHover}
            className="relative border border-white/10 bg-white/5 p-4 rounded w-48 text-center font-mono text-sm"
          >
            ...
            <svg
              className="absolute -bottom-4 -right-4 size-6 text-white fill-current"
              viewBox="0 0 24 24"
            >
        ...
        <div className="space-y-4 relative z-10">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            1-click commits for easy fixes and a &quot;Fix with AI&quot; button
            for harder ones.
          </p>
        </div>
      </FeatureCard>
      ...
      <FeatureCard>
        <div className="flex-1 flex items-center justify-center py-10 opacity-80 group-hover:opacity-100 transition-opacity">
          <motion.div
            variants={cardHover}
            className="w-full max-w-[200px] space-y-2 font-mono text-[10px] text-muted-foreground border border-white/10 bg-black/40 p-3 rounded"
          >
            ...
            <div className="flex justify-center mt-4">
              <div className="size-8 rounded border border-white/20 flex items-center justify-center">
                ⚙️
              </div>
            </div>
          </motion.div>
        ...
        <div className="space-y-4 relative z-10">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            Quick context with a summary of changes, a walkthrough & an
      ...
      <FeatureCard>
        <div className="flex-1 flex items-center justify-center py-10 opacity-80 group-hover:opacity-100 transition-opacity">
          <motion.div
            variants={cardHover}
            className="relative size-32 border border-dashed border-white/20 rounded-full flex items-center justify-center"
          >
            ...
            <div className="size-16 relative">
              <span className="text-4xl absolute inset-0 flex items-center justify-center animate-pulse">
                🐛
              </span>
            </div>
        ...
        <div className="space-y-4 relative z-10">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            We find bugs humans miss - & flag the time consuming and tedious.
            Without the noise.
          </p>
        </div>
      </FeatureCard>
      ...
      >
        <div className="flex-1 flex items-center py-6">
          <motion.div variants={cardHover} className="flex items-center gap-3">
            <div className="size-10 rounded-full bg-secondary overflow-hidden relative">
              <Image
                src="https://api.dicebear.com/7.x/avataaars/svg?seed=jenn"
                alt="avatar"
                fill
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] border border-white/20 rounded px-1 text-muted-foreground">
                  author
                </span>
              ...
              <p className="text-sm mt-1">
                @inspectra we want to get rid of the star imports
              </p>
            </div>
          </motion.div>
        </div>
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            Give feedback on reviews to create Learnings. Or create issues,
            trigger docstrings & more.
          </p>
        </div>
      </motion.div>
      ...
      >
        <div className="flex-1 flex items-center justify-center py-6">
          <motion.div
            variants={cardHover}
            className="font-mono text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-green-400 to-green-800"
          >
            YAML
          </motion.div>
        </div>
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            Customize everything from your coding guidelines to your workflow in
            a yaml file.
          </p>
        </div>
      </motion.div>
      ...
      >
        <div className="flex-1 flex items-center py-6">
          <motion.div
            variants={cardHover}
            className="space-y-2 font-mono text-sm w-full"
          >
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            Automate the creation of your daily standup reports, sprint reviews,
            and more.
          </p>
        </div>
      </motion.div>
...
const ContextSection = () => (
  <section className="py-24 container mx-auto px-4 border-t border-white/5">
    ...
    >
      <motion.div
        variants={fadeIn}
        className="inline-block bg-orange-950/30 text-orange-500 text-xs font-mono font-bold px-2 py-1 mb-4 rounded"
      >
        CR_Quality
      </motion.div>
      <motion.h2
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <motion.p
          ...
          className="text-xl text-muted-foreground font-mono max-w-2xl text-balance"
        >
          Codebase-awareness is tablestakes. We pull in dozens more points of
          context than other tools.
        </motion.p>
        <motion.div variants={fadeIn}>
          <Link
            href="#"
            className="flex items-center gap-2 text-primary hover:text-primary/80 transition-colors font-mono uppercase text-sm tracking-wider"
          >
            See a sample review <ArrowRight className="size-4" />
          </Link>
        </motion.div>
    ...
    >
      ...
      <motion.div
        ...
        className="bg-background p-8 min-h-[400px] flex flex-col justify-between group transition-colors"
      >
        <div className="flex-1 flex items-center justify-center py-10 relative">
          <div className="relative w-full h-40">
            <svg className="w-full h-full" viewBox="0 0 300 150">
              <path
                d="M150 20 L80 80 M150 20 L220 80 M80 80 L50 130 M80 80 L110 130 M220 80 L190 130 M220 80 L250 130"
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            Codegraph and custom guidelines help us understand complex
            dependencies across files to uncover the impact of changes.
          </p>
        </div>
      </motion.div>
      ...
      >
        <div className="flex-1 flex items-center justify-center py-10">
          <div className="relative flex items-center gap-4">
            <div className="flex flex-col gap-2">
              <div className="size-8 bg-[#5E6AD2] rounded p-1.5">
                <svg viewBox="0 0 24 24" fill="white">
                  <path d="M12 2L2 7l10 5 10-5-10-5zm0 9l2-5-2 5zm0 0L2 17l10 5 10-5-10-5z" />
                </svg>
              </div>
              <div className="size-8 bg-black border border-white/20 rounded p-1.5 flex items-center justify-center font-bold text-xs">
                N
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            We bring the right context via MCP servers, Linked Issues (Jira &
            Linear) & Web Query (to fetch the latest info on the web).
          </p>
        </div>
      </motion.div>
      ...
      >
        <div className="flex-1 flex items-center justify-center py-10 relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-5 gap-2 opacity-50">
            {[...Array(15)].map((_, i) => (
              <div
                key={i}
                className={`size-1.5 rounded-full ${[3, 7, 11].includes(i) ? "bg-orange-500 animate-pulse" : "bg-white/20"}`}
              />
            ))}
          </div>
        </div>
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm font-mono leading-relaxed">
            40+ linters and security scanners catch more bugs - while we filter
            out the noise from false positives.
          </p>
        </div>
      </motion.div>
    </motion.div>
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <motion.p
          ...
          className="text-xl text-muted-foreground font-mono max-w-2xl text-balance"
        >
          Set the baseline with your rules and style guides, then train the
          agent with feedback via replies. Reviews improve continuously.
        </motion.p>
      </div>
    </motion.div>
      ...
      >
        {[
          ...
          <motion.div
            variants={fadeIn}
            key={i}
            className={`p-6 border-l-2 cursor-pointer transition-colors ${i === 1 ? "border-primary bg-white/5" : "border-white/10 hover:bg-white/5 text-muted-foreground"}`}
          >
            <h3
              className={`text-lg font-heading font-medium ${i === 1 ? "text-foreground" : ""}`}
            >
              {item}
            </h3>
            {i === 1 && (
              <p className="mt-2 text-sm text-muted-foreground font-mono">
                Easily configurable instructions that let you quickly share how
                you want your code reviewed.
              </p>
            )}
            {i === 1 && <div className="mt-6 w-1/3 h-0.5 bg-primary" />}
          </motion.div>
        ))}
      </motion.div>
      ...
      >
        ...
        <div className="mt-8 space-y-1 text-gray-400">
          <p>
            ...
            <span className="text-purple-400"># .inspectra.yaml</span>
          </p>
          <p>
          ...
          <p>
            ...
            <span className="text-blue-400">early_access:</span>{" "}
          ...
          <p>
            ...
            <span className="text-purple-400 pl-4">profile:</span>{" "}
            <span className="text-green-400">chill</span>
          </p>
          <p>
            <span className="text-gray-600">6</span>{" "}
            <span className="text-purple-400 pl-4">instructions:</span>{" "}
          ...
          <p>
            ...
            <span className="text-gray-300 pl-8">
    ...
    >
      ...
      <motion.div variants={fadeIn} whileHover={{ y: -10 }} className="group">
        <div className="h-48 bg-white/5 border border-white/10 rounded-lg mb-6 flex items-center justify-center overflow-hidden relative transition-colors group-hover:bg-white/10">
          ...
          <svg
            className="size-16 text-purple-400/50 group-hover:text-purple-400 transition-colors"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
        ...
        <p className="text-muted-foreground text-sm font-mono leading-relaxed">
          We protect your code and privacy with an architecture designed to
          ensure your code is private.
        </p>
      </motion.div>
      ...
      <motion.div variants={fadeIn} whileHover={{ y: -10 }} className="group">
        ...
        <p className="text-muted-foreground text-sm font-mono leading-relaxed">
          End-to-end encryption protects your code during reviews with zero data
          retention post-review.
        </p>
      </motion.div>
      ...
      <motion.div variants={fadeIn} whileHover={{ y: -10 }} className="group">
        <div className="h-48 bg-white/5 border border-white/10 rounded-lg mb-6 flex items-center justify-center overflow-hidden relative transition-colors group-hover:bg-white/10">
          {/* Visual: Fingerprint */}
          <svg
            className="size-16 text-orange-400/50 group-hover:text-orange-400 transition-colors"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
        ...
        <p className="text-muted-foreground text-sm font-mono leading-relaxed">
          Enterprise-grade security validated annually through independent SOC2
          Type II audits.
        </p>
      </motion.div>
    </motion.div>
...
const BigFooter = () => (
  ...
  >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            />
            <Button className="w-full border text-white border-orange-500 hover:bg-orange-500/10">
              Subscribe
            </Button>
            <p className="text-[10px] text-muted-foreground">
              By signing up you agree to our{" "}
              <Link href="#" className="underline decoration-muted-foreground">
                Terms of Use
              </Link>{" "}
              and{" "}
              <Link href="#" className="underline decoration-muted-foreground">
    ...
    <div className="w-full flex justify-center overflow-hidden pointer-events-none select-none relative h-[17vw] min-h-[200px]">
      ...
      <span
        className="text-[20vw] font-bold leading-none text-transparent stroke-text absolute -bottom-[4vw]"
        style={{
          WebkitTextStroke: "1px rgba(235, 103, 26, 1)",
          filter: "drop-shadow(0 0 20px rgba(235, 103, 26, 0.8))",
        }}
      >
        CodeLens
      </span>
